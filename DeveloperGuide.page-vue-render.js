...
with(this){return _c('h3',{attrs:{"id":"design-considerations-7"}},[_v("Design Considerations:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#design-considerations-7","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Aspect: How the students are stored to a consultation:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Pros: Store only one of the same person, no duplicates.")]),_v(" "),_c('li',[_v("Cons: May have performance issues in terms of memory usage.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (Current choice):")]),_v(" The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddToConsult")]),_v(" feature creates a new Consultation object with updated student\nlist")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Defensive programming when entirely creating a new Consultation object without modifying previous object.")]),_v(" "),_c('li',[_v("Cons: Require additional checking to inform exception cases.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddToConsult")]),_v(" directly manipulate the attribute students in a Consultation object.")]),_v(" "),_c('ul',[_c('li',[_v("Cons: Poor abstraction and room for errors.")])])])])}
},function anonymous(
) {
